...
def Test(file1,additional_file,file_mode,mapping_mode,z,q):
  ...
  new_file.write("SampleID\tO_antigen\tH1_fliC\tH2_fljB\tantigenic_profile\tserotype\tNotes\n")
  new_file.write(thename.split("_")[0]+"\t"+"O-"+Otype+"\t"+fliC+"\t"+fljB+"\t"+predict_form+"\t"+predict_sero+star+"\t"+star+star_line+"\n")#+##
  new_file.close()
