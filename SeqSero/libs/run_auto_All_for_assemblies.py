...
def Test(file1,z,q):
  ...
  new_file.write(file2.split("_")[0]+"\t"+"O-"+Otype+"\t"+fliC+"\t"+fljB+"\t"+Otype+":"+fliC+":"+fljB+"\t"+(" or ").join(seronames)+"\t"+answer+"\t"+suspect+"\n")
  new_file.close()
  '''
  ...
  new_file.write(file2+"\n"+"O:\t"+"O-"+Otype+"\n"+"H1_fliC:\t"+fliC+"\n"+"H2_fljB:\t"+fljB+"\n"+"antigenic_profile:\t"+predict_form+"\n"+"serotype:\t"+predict_sero+star+"\n"+star+star_line+claim+"\n")##
  new_file.close()
