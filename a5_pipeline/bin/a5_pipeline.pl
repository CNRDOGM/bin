...
use constant {
	...
	SGA_Q_FILTER => 20,
	SGA_DUST => 8,
	SGA_MIN_READ_LENGTH => 70,
	MAX_PAIREDEND_INSERT_MEAN => 1500,
	JAVA_HEAP => -Xmx460800m,
};
...
sub qfilter_trim_paired {
	...
	my $trim_cmd = "java ".JAVA_HEAP." -jar $DIR/trimmomatic.jar SE -threads $threads $trim_phred $WD/$p1_name.both.fastq $WD/$p1_name.trim.fastq LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36";
